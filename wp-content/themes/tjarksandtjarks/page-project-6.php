<?php
/*
	Template Name: 6th Project Page
*/
get_header(); ?>
...
$project_contentFour	= get_field('project_contentFour');
...
<div class="page-content">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="project-fullLow">
					...
					<img src="<?php echo $project_fullFour['url'];?>" alt="<?php echo $project_fullFour['url'];?>" title="<?php echo $project_fullFour['title'];?>">
		...
		<div class="row">
			...
			<?php if(get_field('project_contentFour') ) : ?>
			
			<div class="col-md-12">
				
				<div class="project-about text-row-copy">

					<?php echo $project_contentFour ; ?>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="project-fullLow">
					...
					<img src="<?php echo $project_fullEight['url'];?>" alt="<?php echo $project_fullEight['alt'];?>" title="<?php echo $project_fullEight['title'];?>">
